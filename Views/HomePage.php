...
<head>
    ...
    <link href="wpresscss.css" rel="stylesheet">
</head>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            ...
            <ul class="navbar-nav" id="nav-left">
                <li class="nav-item active">
                    <a class="nav-link" id="home1" href="Index.php?page=Showform">Log in</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="Index.php?page=ShowRegisterform">Register</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div id="slides" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class=" carousel-item active">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-xl-12">
                        <img src="img/Joker3.jpg" class="Cour">
            ...
            <div class=" carousel-item ">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-xl-12">
                        <img src="img/inception-wallpapers-8.jpg" class="Cour">
                        <div class="carousel-caption text-center">
            ...
            <div class=" carousel-item ">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-xl-12">
                        <img src="img/Peaky3.jpg" class="Cour">
                        <div class="carousel-caption text-center">
    ...
    <div class="container-fluid padding">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-4 col-lg-2">
                <img src="img/Sl2.jpg" class="img-thumbnail">
            </div>
